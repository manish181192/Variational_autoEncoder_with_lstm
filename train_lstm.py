...
# ==================================================
x_text_train, y_train, max_document_length, rel_id_Map = DataExtractor.load_data_and_labels_glove(TrainDatapath, True)
x_text_cv, y_dev, _, _ = DataExtractor.load_data_and_labels_glove(Cv_filepath)
# Build vocabulary
